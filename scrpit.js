...
const BOOK_DATABASE = [
    ...
    },
    {
        ...
        tag: "Limited Edition",
        category: "limited",
        excerpt: "A darkly bound chronicle of secret societies.",
        description: "Bound in deep crimson leather with gold foil embossing, this limited edition offers a tactile narrative experience. Includes a hand-signed certificate.",
        image: "assets/book_4.png",
        binding: "Crimson Full-Grain Leather, Gold Foil",
        printRun: "Only 30 copies worldwide",
        paper: "130gsm Velvet Touch Paper",
        releaseDate: "Available Now"
    },
    {
        id: "5",
        title: "Celestial Cartographies",
        author: "Liam Orion",
        price: "$390",
        tag: "Pre-Release",
        category: "pre-release",
        excerpt: "Stellar maps for the modern explorer.",
        description: "A pre‑release volume featuring matte navy cloth cover with silver‑foil constellations, paired with ultra‑rich gloss plates.",
        image: "assets/book_5.png",
        binding: "Matte Navy Cloth, Silver Foil Stamping",
        printRun: "Pre‑release limit: 80 copies",
        paper: "135gsm Premium Art Paper",
        releaseDate: "Releasing August 10, 2026"
    },
    {
        id: "6",
        title: "Midnight Opus",
        ...
        tag: "Limited Edition",
        category: "limited",
        excerpt: "A symphony of midnight shadows bound in onyx leather.",
        description: "Onyx black leather with raised gold script, limited to 25 copies. Includes a velvet ribbon bookmark.",
        image: "assets/book_1.png",
        binding: "Onyx Leather, Gold Script",
        printRun: "25 copies",
        paper: "120gsm Satin Paper",
        releaseDate: "Available Now"
    },
    {
        id: "7",
        title: "Aurora Scrolls",
        author: "Mira Dawn",
        price: "$350",
        tag: "Pre-Release",
        category: "pre-release",
        excerpt: "Luminous poetry collected on luminescent vellum.",
        description: "Features a soft teal cloth cover with gold‑foil aurora designs. Pre‑release edition of 90 copies.",
        image: "assets/book_1.png",
        binding: "Teal Cloth, Gold‑Foil Aurora",
        printRun: "90 copies",
        paper: "140gsm Vellum",
        releaseDate: "Releasing September 5, 2026"
    },
    {
        id: "8",
        title: "Imperial Codex",
        author: "Victor Aurelius",
        price: "$610",
        tag: "Limited Edition",
        category: "limited",
        excerpt: "An imperial tome of ancient decrees.",
        description: "Bound in deep burgundy leather with brass corner protectors, includes gilt‑edge pages. 15 copies.",
        image: "assets/book_1.png",
        binding: "Burgundy Leather, Brass Protectors",
        printRun: "15 copies",
        paper: "150gsm Archival Paper",
        releaseDate: "Available Now"
    },
    {
        id: "9",
        title: "Quantum Quill",
        author: "Dr. Selene Voss",
        price: "$420",
        tag: "Pre-Release",
        category: "pre-release",
        excerpt: "Exploring quantum physics through poetry.",
        description: "Matte charcoal cover with silver‑foil quantum symbols. Limited pre‑release of 70 copies.",
        image: "assets/book_1.png",
        binding: "Charcoal Matte, Silver‑Foil Symbols",
        printRun: "70 copies",
        paper: "130gsm Premium",
        releaseDate: "Releasing October 12, 2026"
    },
    {
        id: "10",
        title: "Silken Chronicles",
        author: "Arianna Silk",
        price: "$390",
        tag: "Limited Edition",
        category: "limited",
        excerpt: "A collection of silk‑bound short stories.",
        description: "Silk‑woven cover with embossed gold pattern, 40 copies, includes silk ribbon.",
        image: "assets/book_1.png",
        binding: "Silk‑Woven, Gold Emboss",
        printRun: "40 copies",
        paper: "125gsm Silk Paper",
        releaseDate: "Available Now"
    },
    {
        id: "11",
        title: "Eclipse Diaries",
        author: "Noah Twilight",
        price: "$460",
        tag: "Limited Edition",
        category: "limited",
        excerpt: "Personal diaries from the era of total eclipses.",
        description: "Dark matte cover with bronze‑foil eclipse engraving, 35 copies.",
        image: "assets/book_1.png",
        binding: "Matte Dark, Bronze‑Foil Engraving",
        printRun: "35 copies",
        paper: "135gsm",
        releaseDate: "Available Now"
    },
    {
        id: "12",
        title: "Starlight Ledger",
        author: "Celeste Nova",
        price: "$380",
        tag: "Pre-Release",
        category: "pre-release",
        excerpt: "Astronomical records bound in midnight blue.",
        description: "Midnight blue cloth with silver‑foil star map, 80 pre‑release copies.",
        image: "assets/book_1.png",
        binding: "Midnight Blue Cloth, Silver‑Foil Star Map",
        printRun: "80 copies",
        paper: "130gsm",
        releaseDate: "Releasing November 20, 2026"
    },
    {
        id: "13",
        title: "Golden Epoch",
        author: "Leonardo Aureus",
        price: "$550",
        tag: "Limited Edition",
        category: "limited",
        excerpt: "Chronicles of the golden age of civilization.",
        description: "Gold‑leaf covered hardback, 20 copies, includes embossed title.",
        image: "assets/book_1.png",
        binding: "Gold‑Leaf Covered Hardback",
        printRun: "20 copies",
        paper: "145gsm",
        releaseDate: "Available Now"
    },
    {
        ...
        author: "Olivia Whisper",
        price: "$340",
        tag: "Pre-Release",
        category: "pre-release",
        excerpt: "A silent musical score bound in velvet.",
        description: "Velvet black cover with gold‑foil musical notes, 85 pre‑release copies.",
        image: "assets/book_1.png",
        binding: "Black Velvet, Gold‑Foil Notes",
        printRun: "85 copies",
        paper: "138gsm",
        releaseDate: "Releasing December 15, 2026"
    },
    {
        id: "15",
        title: "Eternal Manuscript",
        author: "Rafael Immortal",
        price: "$620",
        tag: "Limited Edition",
        category: "limited",
        excerpt: "A manuscript said to never fade.",
        description: "Bound in silver‑stamped leather, 10 copies, includes a metal clasp.",
        image: "assets/book_1.png",
        binding: "Silver‑Stamped Leather, Metal Clasp",
        printRun: "10 copies",
        paper: "150gsm",
        releaseDate: "Available Now"
    }
